...
export default ({ text, selected = false, onClick, link = '' }) => {
    ...
    return (
        <>
            {
                link ? <a href={link} target='_blank' className={`Tab ${selected && 'Tab_selected'}`} onClick={onClick}>
                ...
                </a> : <div className={`Tab ${selected && 'Tab_selected'}`} onClick={onClick}>
                    {/* <div className='Tab_left free_img'>
                <div className="Tab_left_inner" style={{
                    height: tab.current.getBoundingClientRect().height || 60
                    }}></div>
